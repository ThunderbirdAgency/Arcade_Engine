...
export function promptHash(prompt, production = {}) {
  const key = JSON.stringify({ prompt, model: production.model, duration: production.duration, resolution: production.resolution, aspect: production.aspect, mode: production.mode });
